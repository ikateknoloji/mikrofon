        ...
        <div class="col-span-11 flex flex-col">
          ...
          <div class="relative mr-12">
              <img
                ...
                class="max-w-full border border-gray-200 rounded-lg"
              />
          </div>
        </div>
      </div>
        ...
        <div class="p-4 w-full">
          <div class="leading-7">
            <h3 class="text-xl font-bold text-gray-800 mb-4">
              Kurumsal Özel Tasarım Kamera Süngeri ve Baskı Hizmeti
            </h3>
...
const categories = [
  {
    categoryName: "Logo Baskısı + Kamera Süngeri",
    categoryImage: "/cam-mic/11cm.png",
    title: "Kamera Süngeri 11cm",
    description: "Firmalara özel tasarlanmış, logo baskılı kamera süngerleri ile marka kimliğinizi ön plana çıkarın! Dayanıklı malzemelerden üretilmiş olup, uzun ömürlü kullanım sunar. Şık tasarımıyla yayıncılık, röportajlar ve kurumsal etkinlikler için mükemmel bir seçimdir. Kargoya teslim süresi 3 iş günüdür.",
    dimensions: {
      height: "12cm",
      width: "8cm",
      holeWidth: "6cm"
  ...
  {
    categoryName: "Logo Baskısı + Kamera Süngeri",
    categoryImage: "/cam-mic/15cm.png",
    title: "Kamera Süngeri 15cm",
    description: "Kurumsal logo baskısı ile profesyonel bir imaj oluşturun! Dayanıklı ve kaliteli malzemeden üretilen kamera süngerleri, uzun süre kullanım için uygundur. Düz yüzeyi sayesinde baskınız net ve dikkat çekici görünür. Kargoya teslim süresi 3 iş günüdür.",
    dimensions: {
      height: "10cm",
      width: "10cm",
      holeWidth: "5cm"
  ...
  {
    categoryName: "Logo Baskısı + Kamera Süngeri",
    categoryImage: "/cam-mic/18cm.png",
    title: "Kamera Süngeri 18cm",
    description: "Kurumsal kimliğinizi yansıtan özel baskılı kamera süngerleri ile markanızı daha görünür hale getirin! Estetik tasarımı ve dayanıklı yapısıyla profesyonel kullanım için uygundur. Yayıncılık ve medya sektörüne yönelik ideal çözümler sunar. Kargoya teslim süresi 3 iş günüdür.",
    dimensions: {
      height: "15cm",
      width: "15cm",
      holeWidth: "15cm"
  ...
  {
    categoryName: "Logo Baskısı + Silindir Kamera Süngeri",
    categoryImage: "/cam-mic/21cm.png",
    title: "Kamera Süngeri 21cm",
    description: "Şık ve profesyonel görünüme sahip kamera süngerleri ile kurumsal kimliğinizi ön plana çıkarın! Özel logo baskısıyla markanızı güçlendirin. Uzun ömürlü ve dayanıklı malzemesi sayesinde yayıncılık ve röportajlar için ideal bir kullanım sunar. Kargoya teslim süresi 3 iş günüdür.",
    dimensions: {
      height: "10cm",
      width: "5cm",
      holeWidth: "5cm"
