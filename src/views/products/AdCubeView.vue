        ...
        <div class="p-4 w-full">
          <div class="leading-7">
            <h3 class="text-xl font-bold text-gray-800 mb-4">
              Kurumsal Özel Tasarım Reklam Küpü ve Baskı Hizmeti
            </h3>
...
const categories = [
  {
    categoryName: "Reklam Küpü",
    categoryImage: "/reklam/ucgen.png",
    title: "Reklam Küpü Üçgen",
    description: "Firmalara özel tasarlanmış, logo baskılı reklam küpleri ile marka kimliğinizi ön plana çıkarın! Dayanıklı malzemelerden üretilmiş olup, uzun ömürlü kullanım sunar. Şık tasarımıyla kurumsal etkinlikler için mükemmel bir seçimdir. Kargoya teslim süresi 3 iş günüdür.",
    dimensions: {
      height: "10cm",
      width: "10cm",
      holeWidth: "10cm"
  ...
  {
    categoryName: "Reklam Küpü",
    categoryImage: "/reklam/kare.png",
    title: "Reklam Küpü Dörgen",
    description: "Kurumsal logo baskısı ile profesyonel bir imaj oluşturun! Dayanıklı ve kaliteli malzemeden üretilen reklam küpleri, uzun süre kullanım için uygundur. Düz yüzeyi sayesinde baskınız net ve dikkat çekici görünür. Kargoya teslim süresi 3 iş günüdür.",
    dimensions: {
      height: "10cm",
      width: "10cm",
      holeWidth: "10cm"
